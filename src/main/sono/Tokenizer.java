...
public class Tokenizer {
	...
	protected static final Map<String, Integer> operators = Map.ofEntries(
			...
			new SimpleImmutableEntry<String, Integer>("abstract", -15),
			new SimpleImmutableEntry<String, Integer>("struct", -15),
			new SimpleImmutableEntry<String, Integer>("static", -15),
			new SimpleImmutableEntry<String, Integer>("extends", 14),
			...
			//new SimpleImmutableEntry<String, Integer>("com", -11),
			new SimpleImmutableEntry<String, Integer>("::", 16),
